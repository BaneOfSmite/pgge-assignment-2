...
public class Player : MonoBehaviour {
    ...
    public void FireBullet() {
        ...
        Instantiate(mBulletPrefab, firePoint, Quaternion.LookRotation(dir) * Quaternion.AngleAxis(90.0f, Vector3.right))
        .GetComponent<Rigidbody>().AddForce(dir * mBulletSpeed, ForceMode.Impulse);
    }
